...
public class Server {
    ...
    public static void main(String argv[]) {
        ...
        for (int i = 0; i < NUM_REQ_TYPES; i++) {
            switch (i) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    requestStack.push(new PostForm(data.getRandUUID(), data.getRandIP(), data.getRandForm()));
                    break;
                case 4:
                    requestStack.push(new PostEncryptForm(data.getRandUUID(), data.getRandIP(), data.getRandForm(), data.getRandEncryptionScheme()));
                    break;
                case 5:
                    requestStack.push(new PostPayment(data.getRandUUID(), data.getRandIP(), data.getRandPayment()));
                    break;
                case 6:
                    requestStack.push(new PostEncryptPayment(data.getRandUUID(), data.getRandIP(), data.getRandPayment(), data.getRandEncryptionScheme()));
                    break;
                case 7:
        ...
        System.out.println("Post Form Requests: " + PostForm.count());
        System.out.println("Post Encrypted Form Requests: " + PostEncryptForm.count());
        System.out.println("Post Payment Requests: " + PostPayment.count());
        System.out.println("Post Encrypted Payment Requests: " + PostEncryptPayment.count());
